...
<html lang="en">
  <head>
    ...
    <!-- Begin SEO tag -->
    <title> Profile Settings | Looper - Bootstrap 4 Admin Theme </title>
          ...
          <section class="aside-menu overflow-hidden">
            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
                <!-- .menu-item -->
                <li class="menu-item">
                  <a href="index.html" class="menu-link"><span class="menu-icon fa fa-home"></span> <span class="menu-text">Dashboard</span></a>
                </li><!-- /.menu-item -->
                <!-- .menu-item -->
